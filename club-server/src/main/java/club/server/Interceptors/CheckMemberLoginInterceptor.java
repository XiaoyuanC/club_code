...
@Component
public class CheckMemberLoginInterceptor implements HandlerInterceptor {
    //check token
    @Override
    public boolean preHandle(HttpServletRequest request,
        ...
        if(!StringUtil.isNullOrEmpty(token)){
            ...
            if(decodedJWT!=null&&decodedJWT.getClaim("type")!=null&&decodedJWT.getClaim("type").asInt()==0){
                return true;
            }
        }
